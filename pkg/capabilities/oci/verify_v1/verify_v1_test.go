...
type v1VerifyTestCase struct {
	...
	checkIsTrustedFunc func(host VerifyV1Host, request easyjson.Marshaler) (bool, error)
}
...
func CheckPubKeysTrustedV1(host VerifyV1Host, request easyjson.Marshaler) (bool, error) {
...
func CheckKeylessTrustedV1(host VerifyV1Host, request easyjson.Marshaler) (bool, error) {
